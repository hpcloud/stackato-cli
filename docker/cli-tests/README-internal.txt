...
The 'Kettle' package and application, plus dependencies.
More details about this in a moment, see the next section.
...
Kettle is a package and application to make dev of Tcl packages
