...
apply {{} {
	...
	STACKATO_CLI_TEST_SECGROUP thesecgroup    cli-test-security-group
	STACKATO_CLI_TEST_SPACEQ   thespacequota  cli-test-space-quota
	...
	STACKATO_CLI_TEST_SBROKER_L thebroker      http://kvmbuild.activestate.com:5000
	STACKATO_CLI_TEST_SBROKER_U thebrokeruser  foo
	STACKATO_CLI_TEST_SBROKER_P thebrokerpass  bar
    } {
