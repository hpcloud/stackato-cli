...
## Copyright (c) 20xx-2011 Donal Fellows, BSD licensed.
## Taken from the Tcl 8.6 development branch. This was
## the prototype implementation of try/finally as Tcl
## code before it was re-implemented in C.

## Backporting work for Tcl 8.5 by ActiveState Software Inc.
