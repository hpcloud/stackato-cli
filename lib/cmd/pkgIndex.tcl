...
package ifneeded stackato::cmd::secgroups     0        [list source [file join $dir secgroups.tcl]]
...
package ifneeded stackato::cmd::spacequotas   0        [list source [file join $dir spacequotas.tcl]]
